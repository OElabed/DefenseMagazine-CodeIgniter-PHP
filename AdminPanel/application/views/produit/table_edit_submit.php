...
<?php echo form_open_multipart('produit/edit_submit/'.$this->uri->segment(3), array('name'=>'myform'));?>
<?php
							...
							<table width="200" border="0">
							  ...
							  <tr>
                                ...
                                <td>
								 ...
								 <input type="checkbox" name="mod_img" onclick=showMe('mod_img',this) value="" checked="checked"> &nbsp;
