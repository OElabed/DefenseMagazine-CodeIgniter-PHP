  ...
  <tbody>
	...
	<tr>
	  ...
	  <div id="table_gerer_affiche">
				...
				<?php
					echo form_open('commande/ajout_adr_liv',array('name' =>'ajout_adr'));
			...
			<tr colspan="2" rowspan="1" class="input_connexion">
				<td style="padding-bottom:30px;"><h4>Adresse de livraison</h4></td>
			</tr>
			...
			<tr>
		      <td colspan="2" rowspan="1" style="height:20px"></td>
		    </tr>
			<tr class="input_connexion">
		      <td colspan="2" rowspan="1">
			  	<input type="checkbox" name ="fct_quest" value="meme" /><b> &nbsp;&nbsp;Choisir une adresse de facturation différente</b>
			  </td>
		    </tr>
		    <tr>
