            ...
            <div id="titre_box">
              <p><strong>Menu</strong></p>
				 ...
				 <?php foreach($categ['list_categ_a'] as $row){
				 		if($row->nom_categorie == $fiche_categ['categ_parent']){?>
							 ...
							 <div id="menu_sous_categ">
								<?php foreach($categ['list_categ_b'] as $row1){
									if($row1->categorie_pere == $row->id_categorie){
										if($row1->nom_categorie == $fiche_categ['nom_catego']){?>
											<p class="select_categ"><a href="<?php echo base_url().'categorie/sous_categorie_affiche/'.$row1->nom_categorie;?>">> <?php echo $row1->nom_categorie;?></a></p>
